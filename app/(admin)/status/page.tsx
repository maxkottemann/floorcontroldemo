...
export default function StatusPage() {
  ...
  // Unique washed floor ids (a floor can be washed multiple times)
  ...
  // Floor type distribution (from allFloors)
  const vloertypeMap: Record<string, number> = {};
  for (const f of allFloors) {
    const key = f.vloertype_naam ?? "Onbekend";
  ...
  // Reinigingsmethode distribution — count per methode
          ...
          <div className="space-y-6">
            ...
            {!activeProject ? (
              ...
              <>
                    ...
                    {totalFloors === 0 ? (
                      ...
                      <div className="space-y-5">
                        {[
                          ...
                          const pct =
                            totalFloors > 0
                              ? Math.round((count / totalFloors) * 100)
                              : 0;
                          return (
                            <div key={label}>
                ...
                {/* Row 2 — Activity + Opmerkingen + Wagens */}
