            ...
            <div className="space-y-4 md:space-y-6">
              <div>
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <button
                    onClick={() =>
                      router.push(`/vloerscans/wijzigen/${scan.id}`)
                    }
                    className="inline-flex items-center gap-2 px-3 md:px-4 py-2.5 bg-white hover:bg-slate-50 text-slate-500 hover:text-slate-700 text-sm font-semibold rounded-xl border border-slate-200 hover:border-slate-300 shadow-sm transition-all cursor-pointer shrink-0"
                  >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                    ...
                    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                      ...
                      <div className="p-4 md:p-5 space-y-3">
                        ...
                        <button
                          onClick={() =>
                            router.push(`/locaties/bekijken/${scan.locatie_id}`)
                          }
