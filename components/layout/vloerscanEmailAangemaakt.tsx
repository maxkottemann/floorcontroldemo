...
export interface VloerscanAangemaaktEmailProps {
  scanNaam: string;
  beschrijving?: string;
  startDatum: string;
  eindDatum?: string;
...
export const VloerscanAangemaaktEmail = ({
  scanNaam,
  beschrijving,
  startDatum,
  eindDatum,
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          Duofort heeft een vloerscan ingepland voor uw locatie. Hieronder vindt
          u alle details.
        </p>
      </div>
